...
export const metadata: Metadata = {
  title: "About",
  description:
    "About the Department of Artificial Intelligence, St. Joseph's College (Autonomous), Tiruchirappalli, and the team behind AION 2K26 2.0.",
  alternates: {
    canonical: "/about",
  },
};
...
const GRADIENT_TEXT =
  "bg-[linear-gradient(135deg,#3B82F6_0%,#8B5CF6_100%)] bg-clip-text text-transparent";
        ...
        {FACULTY.map((member) => (
          ...
          >
            <div className="relative h-[280px] w-full overflow-hidden bg-[linear-gradient(135deg,rgba(59,130,246,0.2),rgba(139,92,246,0.2))]">
              ...
              />
              <div className="absolute top-4 right-4 transition-all duration-300 group-hover:translate-y-0 sm:translate-y-[-10px] sm:opacity-0 sm:group-hover:opacity-100">
                <span
                  className={cn(
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      <div className="mb-16 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-slate-400">
          Student leaders driving the vision and execution of AION 2K26 2.0
        </p>
      </div>
...
function DevSection() {
  ...
  return (
    <section
      id="developer-system-admin"
      className="relative overflow-hidden border-t border-white/10 px-6 py-16"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(59,130,246,0.06),rgba(139,92,246,0.06))]"
      />
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-4 text-4xl font-bold sm:text-5xl">
            Developer &amp;{" "}
            <span className="text-purple-500">System Admin</span>
          </h2>
          <p className="mx-auto max-w-2xl text-lg text-slate-400">
            Building and maintaining AION 2K26 2.0
          </p>
        </div>
        ...
        <div className="mx-auto max-w-md space-y-6">
          {devs.map((dev) => (
            <div
              key={dev.name}
              className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.05] p-8 text-center backdrop-blur-[10px] transition-all duration-300 hover:-translate-y-1.5 hover:border-blue-500/40 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)]"
            >
              <div
              ...
              <div
                aria-hidden="true"
                className="absolute -top-24 left-1/2 h-48 w-48 -translate-x-1/2 rounded-full bg-blue-500/10 blur-3xl transition-opacity duration-300 group-hover:opacity-150"
              />

              <div className="relative z-10">
                <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-[linear-gradient(135deg,#3B82F6,#8B5CF6)] text-2xl font-bold text-white shadow-[0_8px_24px_rgba(59,130,246,0.3)]">
                  JL
                </div>
                ...
                <p className="mb-6 text-sm text-slate-400">{dev.degree}</p>

                <div
                  className="mx-auto mb-6 h-px w-16 bg-gradient-to-r from-transparent via-blue-500/50 to-transparent"
                  aria-hidden="true"
                />
                ...
                <div className="flex flex-col items-center gap-3">
                  <a
                    href={dev.phoneHref}
                    className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-4 py-2 text-sm text-slate-300 transition-colors hover:border-blue-500/40 hover:text-blue-400"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 px-5 py-2 text-sm font-semibold text-white shadow-[0_4px_16px_rgba(59,130,246,0.3)] transition-transform hover:-translate-y-0.5"
                  >
                    LinkedIn
                    <span aria-hidden="true">↗</span>
                  </a>
