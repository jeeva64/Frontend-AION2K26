...
export type SlotLabel = "Slot 1" | "Slot 2" | "Both";
export type EventSlot = SlotLabel;
...
export const EVENT_SLOT_MAP = {
  ...
  "ThinkSync": "Slot 2",
  "Crazy Sell": "Slot 2"
} as const satisfies Record<EventName, SlotLabel>;
...
// Slot badge colors
export const SLOT_COLORS: Record<SlotLabel, string> = {
