      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
        ...
        <div className="hidden items-center gap-8 text-sm font-medium md:flex">
          ...
          <button
            ...
            className="nav-link transition-colors text-slate-200/85 hover:text-blue-400"
          >
            Logout
          </button>
        </div>
      ...
      {mobileOpen && (
        <div className="space-y-4 border-t border-white/10 bg-slate-900/95 px-6 py-5 backdrop-blur-xl md:hidden">
          ...
          <button
            type="button"
            onClick={handleLogout}
            className="mt-3 block w-full rounded-full bg-blue-600 py-2 text-center font-semibold text-white transition hover:bg-blue-700"
          >
            Logout
          </button>
        </div>
